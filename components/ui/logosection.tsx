  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          With certified professionals and a deep understanding of global
          compliance standards, SafeGrey delivers security you can trust and
          ensures you receive{" "}
          <motion.span
          ...
          <Marquee>
            ...
            <MarqueeContent className="flex items-center gap-8">
              {logos.map((logo, index) => (
                ...
                >
                  <motion.div className="absolute inset-0 bg-gradient-to-br from-[var(--theme-accent)]/20 to-[var(--theme-accent-dim)]/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                  <motion.div
