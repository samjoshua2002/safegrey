          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <p style="margin: 0 0 16px 0; color: #4a5568; font-size: 16px; line-height: 1.6;">
                Thank you for your interest in our ${assessmentType} services. We're committed to helping you secure your cloud infrastructure and workloads.
              </p>
              <p style="margin: 0 0 16px 0; color: #4a5568; font-size: 16px; line-height: 1.6;">
          ...
          <tr>
            <td style="padding: 30px; text-align: center;">
              ...
              <p style="margin: 0 0 4px 0; color: #718096; font-size: 13px;">
                Expert-Led Cloud Security Services
              </p>
  ...
  try {
    ...
    try {
      ...
      await DatasheetDownload.create({
        ...
        serviceCategory: 'Cloud Security',
