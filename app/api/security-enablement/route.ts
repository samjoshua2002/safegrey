          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <p style="margin: 0 0 16px 0; color: #4a5568; font-size: 16px; line-height: 1.6;">
                Thank you for your interest in our ${serviceType} services. We're committed to providing ongoing support, specialized expertise, and purpose-built tools.
              </p>
              <p style="margin: 0 0 16px 0; color: #4a5568; font-size: 16px; line-height: 1.6;">
                We've attached a detailed guide covering our service methodologies.
              </p>
          ...
          <tr>
            <td style="padding: 30px; text-align: center;">
              ...
              <p style="margin: 0 0 4px 0; color: #718096; font-size: 13px;">
                Expert-Led Security Enablement Services
              </p>
  ...
  try {
    ...
    try {
      ...
      await DatasheetDownload.create({
        ...
        serviceCategory: 'Security Enablement',
    ...
    // Get PDF path
    const pdfFilename = `${serviceType}.pdf`;
    const pdfPath = path.join(process.cwd(), 'public', 'security-enablement', pdfFilename);
