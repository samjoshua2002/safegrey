          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <p style="margin: 0 0 16px 0; color: #4a5568; font-size: 16px; line-height: 1.6;">
                Thank you for your interest in our ${serviceType} services. We're committed to providing continuous monitoring, rapid detection, and structured response support.
              </p>
              <p style="margin: 0 0 16px 0; color: #4a5568; font-size: 16px; line-height: 1.6;">
  ...
  try {
    ...
    try {
      ...
      await DatasheetDownload.create({
        ...
        serviceCategory: 'Managed Security',
    ...
    const pdfPath = path.join(process.cwd(), 'public', 'managed-security', pdfFilename);
